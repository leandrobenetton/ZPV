...
-------------------------------------------------------------------------------
DECLARE @FormID int
DELETE FROM PropertyDefaults WHERE [PropertyName] = N'ZPV_ThirtyBank' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 

DELETE FROM PropertyDefaultDragDropEvents WHERE [PropertyName] = N'ZPV_ThirtyBank' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 
...
VALUES ( 
 N'ZPV_ThirtyBank', 1, N'[NULL]', 
 NULL, NULL, N'STDOLE ZLA_Banks(  PROPERTIES(BankId, Description) DISPLAY(1,2))', 
 NULL, NULL, NULL, 
 N'ZPV_ThirtyBank(%1),ZPV_ValidateTerms', 0, 1, 0, 
 NULL, NULL, 0, 0, 0, 
 NULL, NULL, NULL, NULL, 
 NULL, NULL, 0, NULL, 
