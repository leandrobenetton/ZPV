...
-------------------------------------------------------------------------------
DECLARE @FormID int
DELETE FROM PropertyDefaults WHERE [PropertyName] = N'ZPV_ZlaPayTypeAR' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 

DELETE FROM PropertyDefaultDragDropEvents WHERE [PropertyName] = N'ZPV_ZlaPayTypeAR' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 
...
VALUES ( 
 N'ZPV_ZlaPayTypeAR', 1, N'[NULL]', 
 NULL, NULL, N'STDOLE ZLA_SysLastTrans(  PROPERTIES(LastttranId, Description) DISPLAY(1,2)FILTER(Type=''ARO''))', 
 N'ZLA_ARPaymentSequences', N'LastttranId', N'ZLA_ARPaymentSequences', 
 NULL, 0, 0, 0, 
 NULL, NULL, 0, 0, 0, 
 NULL, NULL, NULL, NULL, 
