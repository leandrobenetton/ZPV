...
-------------------------------------------------------------------------------
DECLARE @FormID int
DELETE FROM PropertyDefaults WHERE [PropertyName] = N'ZRT_POSPayType' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 

DELETE FROM PropertyDefaultDragDropEvents WHERE [PropertyName] = N'ZRT_POSPayType' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 
...
VALUES ( 
 N'ZRT_POSPayType', 1, N'[NULL]', 
 NULL, NULL, N'STDOLE ZRT_POSMPayTypes(  PROPERTIES(PosmPayType, Description, Logifld, ZrtTermsCode, BankCode, ZlaBankType, TransType) DISPLAY(1,2))', 
 NULL, NULL, N'ZRT_POSSetup( )', 
 N'ZRT_POSPayCode(%1,%2,%3,%4)', 0, 1, 0, 
 NULL, NULL, 0, 0, 0, 
 NULL, NULL, NULL, NULL, 
 NULL, NULL, 0, NULL, 
