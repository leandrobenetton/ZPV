...
-------------------------------------------------------------------------------
DECLARE @FormID int
DELETE FROM PropertyDefaults WHERE [PropertyName] = N'ZPV_DrawerPos' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 

DELETE FROM PropertyDefaultDragDropEvents WHERE [PropertyName] = N'ZPV_DrawerPos' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 
...
VALUES ( 
 N'ZPV_DrawerPos', 1, N'[NULL]', 
 NULL, NULL, N'STDOLE ZPV_DrawerPos(  PROPERTIES(Drawer, Pos, DerDrwDescription) DISPLAY(1,3)FILTER(Pos=FV(vPOS) AND Drawer <> FP(drawer)))', 
 NULL, NULL, NULL, 
 NULL, 0, 0, 0, 
 NULL, NULL, 0, 0, 0, 
 NULL, NULL, NULL, NULL, 
