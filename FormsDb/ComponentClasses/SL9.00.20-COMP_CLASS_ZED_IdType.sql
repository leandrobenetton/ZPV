...
-------------------------------------------------------------------------------
DECLARE @FormID int
DELETE FROM PropertyDefaults WHERE [PropertyName] = N'ZED_IdType' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 

DELETE FROM PropertyDefaultDragDropEvents WHERE [PropertyName] = N'ZED_IdType' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 
...
VALUES ( 
 N'ZED_IdType', 1, N'[NULL]', 
 NULL, NULL, N'STDOLE ZED_IdType(  PROPERTIES(IdNum, IdDetail) DISPLAY(1,2)ORDERBY(IdDetail asc))', 
 N'ZED_IdType', N'IdNum', N'ZED_IdType', 
 N'SetComponentFromList(IdDetail,ZED_IdDetailEdit)', 0, 1, 0, 
 NULL, NULL, 0, 0, 0, 
 NULL, NULL, NULL, NULL, 
