...
-------------------------------------------------------------------------------
DECLARE @FormID int
DELETE FROM PropertyDefaults WHERE [PropertyName] = N'ZED_PaymentConcept' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 

DELETE FROM PropertyDefaultDragDropEvents WHERE [PropertyName] = N'ZED_PaymentConcept' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 
...
VALUES ( 
 N'ZED_PaymentConcept', 1, N'[NULL]', 
 NULL, NULL, N'STDOLE ZED_PayConc(  PROPERTIES(ConceptNum, ConceptDetail) DISPLAY(1,2)ORDERBY(ConceptDetail asc))', 
 NULL, N'ConceptNum', N'ZED_PaymentConcept', 
