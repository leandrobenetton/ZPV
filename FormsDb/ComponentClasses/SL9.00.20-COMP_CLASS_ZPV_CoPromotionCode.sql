...
-------------------------------------------------------------------------------
DECLARE @FormID int
DELETE FROM PropertyDefaults WHERE [PropertyName] = N'ZPV_CoPromotionCode' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 

DELETE FROM PropertyDefaultDragDropEvents WHERE [PropertyName] = N'ZPV_CoPromotionCode' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 
...
VALUES ( 
 N'ZPV_CoPromotionCode', 1, N'[NULL]', 
 NULL, NULL, N'STDMC ZPV_SLCoitems.ZPV_CLM_PricePromotionsSp( V(lsm1_ZPV_CoPromotionCode) PROPERTIES(PromotionCode, PromotionCodeDesc) DISPLAY(1,2))', 
 NULL, NULL, NULL, 
 N'ZPV_PromotionCode(%1)', 0, 1, 0, 
 NULL, NULL, 0, 0, 0, 
 NULL, NULL, NULL, NULL, 
 NULL, NULL, 0, NULL, 
