...
-------------------------------------------------------------------------------
DECLARE @FormID int
DELETE FROM PropertyDefaults WHERE [PropertyName] = N'ZRT_LotsForCoLines' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 

DELETE FROM PropertyDefaultDragDropEvents WHERE [PropertyName] = N'ZRT_LotsForCoLines' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 
...
VALUES ( 
 N'ZRT_LotsForCoLines', 1, N'[NULL]', 
 NULL, NULL, N'STDOLE ZRT_SLLotLocs(  PROPERTIES(Lot, Whse, DerQtyAvailable) DISPLAY(1,2,3)FILTER(Item=FP(SLCoBlns.Item) AND DerQtyAvailable>=FP(SLCoBlns.BlanketQtyConv)))', 
 NULL, NULL, NULL, 
 N'ZRT_TempResWhse(%1)', 0, 1, 0, 
 NULL, NULL, 0, 0, 0, 
 NULL, NULL, NULL, NULL, 
 NULL, NULL, 0, NULL, 
