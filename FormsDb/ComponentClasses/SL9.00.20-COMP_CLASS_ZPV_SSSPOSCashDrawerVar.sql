...
-------------------------------------------------------------------------------
DECLARE @FormID int
DELETE FROM PropertyDefaults WHERE [PropertyName] = N'ZPV_SSSPOSCashDrawerVar' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 

DELETE FROM PropertyDefaultDragDropEvents WHERE [PropertyName] = N'ZPV_SSSPOSCashDrawerVar' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 
...
VALUES ( 
 N'ZPV_SSSPOSCashDrawerVar', 1, N'[NULL]', 
 NULL, NULL, N'STDOLE POSMDrawers(  PROPERTIES(Drawer, Description, DerCheckOutBy, OrderType, Username, PartnerId, Whse, TermsCode, ZPVPosCode) DISPLAY(1,2,3))', 
 NULL, NULL, NULL, 
 N'ZPV_POSCashDrawer(%1)', 0, 1, 0, 
 NULL, NULL, 0, 0, 0, 
 NULL, NULL, NULL, NULL, 
 NULL, NULL, 0, NULL, 
