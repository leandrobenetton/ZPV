...
-------------------------------------------------------------------------------
DECLARE @FormID int
DELETE FROM PropertyDefaults WHERE [PropertyName] = N'ZRT_CoCodes' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 

DELETE FROM PropertyDefaultDragDropEvents WHERE [PropertyName] = N'ZRT_CoCodes' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 
...
VALUES ( 
 N'ZRT_CoCodes', 1, N'[NULL]', 
 NULL, NULL, N'STDOLE ZRT_CoCodes(  PROPERTIES(CustType, EndUserType, DocId) DISPLAY(1))', 
 NULL, NULL, NULL, 
 N'ZRT_EndUserCustTypeDocId(%1)', 0, 1, 0, 
 NULL, NULL, 0, 0, 0, 
 NULL, NULL, NULL, NULL, 
 NULL, NULL, 0, NULL, 
