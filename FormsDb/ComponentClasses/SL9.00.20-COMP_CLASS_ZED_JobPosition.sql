...
-------------------------------------------------------------------------------
DECLARE @FormID int
DELETE FROM PropertyDefaults WHERE [PropertyName] = N'ZED_JobPosition' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 

DELETE FROM PropertyDefaultDragDropEvents WHERE [PropertyName] = N'ZED_JobPosition' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 
...
VALUES ( 
 N'ZED_JobPosition', 1, N'[NULL]', 
 NULL, NULL, N'STDOLE ZED_JobPosition(  PROPERTIES(JobId, JobDetail) DISPLAY(1,2))', 
 N'ZED_JobPosition', N'JobId', N'ZED_JobPosition', 
 NULL, 0, 1, 0, 
 NULL, NULL, 0, 0, 0, 
 NULL, NULL, NULL, NULL, 
