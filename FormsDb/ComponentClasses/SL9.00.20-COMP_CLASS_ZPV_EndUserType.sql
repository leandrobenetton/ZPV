...
-------------------------------------------------------------------------------
DECLARE @FormID int
DELETE FROM PropertyDefaults WHERE [PropertyName] = N'ZPV_EndUserType' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 

DELETE FROM PropertyDefaultDragDropEvents WHERE [PropertyName] = N'ZPV_EndUserType' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 
...
VALUES ( 
 N'ZPV_EndUserType', 1, N'[NULL]', 
 NULL, NULL, N'STDOLE ZPV_PosEndUsers(  PROPERTIES(EndUserType, description, PosCode, DerEndUserTypeI, DerEndUserTypeC, DerEndUserTypeD) DISPLAY(1,2,4)FILTER(PosCode=FV(ZpvPOS)))', 
 NULL, NULL, N'ZLA_EndUserTypes', 
 N'ZPV_EndUserType(%1,%2)', 0, 1, 0, 
 NULL, NULL, 0, 0, 0, 
 NULL, NULL, NULL, NULL, 
 NULL, NULL, 0, NULL, 
