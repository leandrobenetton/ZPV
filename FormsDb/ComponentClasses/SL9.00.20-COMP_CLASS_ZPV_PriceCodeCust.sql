...
-------------------------------------------------------------------------------
DECLARE @FormID int
DELETE FROM PropertyDefaults WHERE [PropertyName] = N'ZPV_PriceCodeCust' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 

DELETE FROM PropertyDefaultDragDropEvents WHERE [PropertyName] = N'ZPV_PriceCodeCust' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 
...
VALUES ( 
 N'ZPV_PriceCodeCust', 1, N'[NULL]', 
 NULL, NULL, N'STDOLE SL.SLPricecodes(  PROPERTIES(Pricecode, Description, Markup1) DISPLAY(1,2)FILTER(CustItem = ''C'')ORDERBY(Pricecode))', 
 NULL, NULL, NULL, 
 N'ZPV_PriceCodeCust(%1,%2)', 0, 1, 0, 
 NULL, NULL, 0, 0, 0, 
 NULL, NULL, NULL, NULL, 
 NULL, NULL, 0, N'StdDetailsAddFindDemandID', 
