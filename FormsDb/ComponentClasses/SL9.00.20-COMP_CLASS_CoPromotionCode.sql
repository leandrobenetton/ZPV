...
-------------------------------------------------------------------------------
DECLARE @FormID int
DELETE FROM PropertyDefaults WHERE [PropertyName] = N'CoPromotionCode' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 

DELETE FROM PropertyDefaultDragDropEvents WHERE [PropertyName] = N'CoPromotionCode' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 
...
VALUES ( 
 N'CoPromotionCode', 1, N'[NULL]', 
 NULL, NULL, N'STDMC SLCoitems.CLM_PricePromotionsSp( V(lsm1_CoPromotionCode) PROPERTIES(PromotionCode) DISPLAY(1))', 
 NULL, NULL, NULL, 
 N'GenerateEventWithMessage(%6)', 0, 1, 0, 
 NULL, NULL, 0, 0, 0, 
 NULL, NULL, NULL, NULL, 
 NULL, NULL, 0, NULL, 
