...
-------------------------------------------------------------------------------
DECLARE @FormID int
DELETE FROM PropertyDefaults WHERE [PropertyName] = N'ZPV_LogStat' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 

DELETE FROM PropertyDefaultDragDropEvents WHERE [PropertyName] = N'ZPV_LogStat' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 
...
VALUES ( 
 N'ZPV_LogStat', 1, N'[NULL]', 
 NULL, NULL, N'STDOLE ZPV_LogisStats(  PROPERTIES(LogCode, Description, CoZpvStat) DISPLAY(1,2)FILTER(CoZpvStat=FP(ZpvStat)))', 
 NULL, NULL, NULL, 
 N'ZPV_Logis1(%1)', 0, 1, 0, 
 NULL, NULL, 0, 0, 0, 
 NULL, NULL, NULL, NULL, 
 NULL, NULL, 0, NULL, 
