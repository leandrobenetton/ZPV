...
-------------------------------------------------------------------------------
DECLARE @FormID int
DELETE FROM PropertyDefaults WHERE [PropertyName] = N'ZPV_CustaddrsSeq' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 

DELETE FROM PropertyDefaultDragDropEvents WHERE [PropertyName] = N'ZPV_CustaddrsSeq' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 
...
VALUES ( 
 N'ZPV_CustaddrsSeq', 1, N'[NULL]', 
 NULL, NULL, N'STDOLE ZPV_Custaddrs(  PROPERTIES(CustSeq, Type, Addr1, Addr2) DISPLAY(1,2,3,4)FILTER(CoNum=FP(CoNum)))', 
 NULL, NULL, NULL, 
 NULL, 0, 0, 0, 
 NULL, NULL, 0, 0, 0, 
 NULL, NULL, NULL, NULL, 
