...
-------------------------------------------------------------------------------
DECLARE @FormID int
DELETE FROM PropertyDefaults WHERE [PropertyName] = N'ZPV_Customer' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 

DELETE FROM PropertyDefaultDragDropEvents WHERE [PropertyName] = N'ZPV_Customer' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 
...
VALUES ( 
 N'ZPV_Customer', 1, N'[NULL]', 
 NULL, NULL, N'STDOLE SL.SLCustomers(  PROPERTIES(CustNum, Name, TaxRegNum1) DISPLAY(1,2)FILTER(CustSeq = 0))', 
 N'CustomersQuery( )', N'CustNum', N'Customers', 
 N'ZPV_Customer(%1,%2)', 0, 1, 0, 
 NULL, NULL, 0, 0, 0, 
 NULL, NULL, NULL, NULL, 
