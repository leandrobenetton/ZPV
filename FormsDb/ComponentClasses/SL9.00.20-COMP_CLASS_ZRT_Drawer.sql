...
-------------------------------------------------------------------------------
DECLARE @FormID int
DELETE FROM PropertyDefaults WHERE [PropertyName] = N'ZRT_Drawer' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 

DELETE FROM PropertyDefaultDragDropEvents WHERE [PropertyName] = N'ZRT_Drawer' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 
...
VALUES ( 
 N'ZRT_Drawer', 1, N'[NULL]', 
 NULL, NULL, N'STDOLE ZRT_Drawers(  PROPERTIES(drawer, description, POS) DISPLAY(1,2))', 
 NULL, NULL, N'ZRT_Drawer( )', 
 N'ZRT_DrawerPOS(%1,%2)', 0, 1, 0, 
 NULL, NULL, 0, 0, 0, 
 NULL, NULL, NULL, NULL, 
