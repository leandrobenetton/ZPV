...
-------------------------------------------------------------------------------
DECLARE @FormID int
DELETE FROM PropertyDefaults WHERE [PropertyName] = N'ZRT_CoPaymentLine' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 

DELETE FROM PropertyDefaultDragDropEvents WHERE [PropertyName] = N'ZRT_CoPaymentLine' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 
...
VALUES ( 
 N'ZRT_CoPaymentLine', 1, N'[NULL]', 
 NULL, NULL, NULL, 
 NULL, NULL, NULL, 
 N'ZRT_CoPaymentLine(%1)', 0, 1, 0, 
 NULL, NULL, 0, 0, 0, 
 NULL, NULL, NULL, NULL, 
 NULL, NULL, 0, NULL, 
 N'DATATYPE(DECIMAL) LENGTH(10) DECIMALPOINT(2)', N'AUTOIME(NoControl) JUSTIFY(R)' ) 
