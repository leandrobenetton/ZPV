...
-------------------------------------------------------------------------------
DECLARE @FormID int
DELETE FROM PropertyDefaults WHERE [PropertyName] = N'SSSPOSPaymentType' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 

DELETE FROM PropertyDefaultDragDropEvents WHERE [PropertyName] = N'SSSPOSPaymentType' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 
...
VALUES ( 
 N'SSSPOSPaymentType', 1, N'[NULL]', 
 NULL, NULL, N'STDOLE POS.POSMPayTypes(  V(lsp_SSSPOSPaymentType) DISPLAY(1,2,3,4))', 
 NULL, NULL, NULL, 
 N'SSSPOSPayTypes', 0, 1, 0, 
 NULL, NULL, 0, 0, 0, 
 NULL, NULL, NULL, NULL, 
 NULL, NULL, 0, NULL, 
