...
-------------------------------------------------------------------------------
DECLARE @FormID int
DELETE FROM PropertyDefaults WHERE [PropertyName] = N'ZRT_TermsCode' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 

DELETE FROM PropertyDefaultDragDropEvents WHERE [PropertyName] = N'ZRT_TermsCode' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 
...
VALUES ( 
 N'ZRT_TermsCode', 1, N'[NULL]', 
 N'%1 - Description property name', NULL, N'STDOLE ZRT_SLTerms(  PROPERTIES(TermsCode, Description, ZrtDescGroup, DiscPct) DISPLAY(1,2,3,4))', 
 NULL, NULL, NULL, 
 N'ZRT_TermsCode(%1,%2,%3)', 0, 1, 0, 
 NULL, NULL, 0, 0, 0, 
 NULL, NULL, NULL, NULL, 
 NULL, NULL, 0, NULL, 
