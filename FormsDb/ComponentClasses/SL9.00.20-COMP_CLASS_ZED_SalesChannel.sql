...
-------------------------------------------------------------------------------
DECLARE @FormID int
DELETE FROM PropertyDefaults WHERE [PropertyName] = N'ZED_SalesChannel' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 

DELETE FROM PropertyDefaultDragDropEvents WHERE [PropertyName] = N'ZED_SalesChannel' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 
...
VALUES ( 
 N'ZED_SalesChannel', 1, N'[NULL]', 
 NULL, NULL, N'STDOLE ZED_SalesChannel(  PROPERTIES(ChannelNum, ChannelDetail) DISPLAY(1,2)ORDERBY(ChannelDetail asc))', 
 N'ZED_SalesChannel', N'ChannelNum', N'ZED_SalesChannel', 
 N'SetComponentFromList(ChannelDetail,ZedSalesChannelDetail)', 0, 1, 0, 
 NULL, NULL, 0, 0, 0, 
 NULL, NULL, NULL, NULL, 
