...
-------------------------------------------------------------------------------
DECLARE @FormID int
DELETE FROM PropertyDefaults WHERE [PropertyName] = N'ZPVPromCode' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 

DELETE FROM PropertyDefaultDragDropEvents WHERE [PropertyName] = N'ZPVPromCode' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 
...
VALUES ( 
 N'ZPVPromCode', 1, N'[NULL]', 
 NULL, NULL, N'STDOLE ZPV_SLPricePromotions(  PROPERTIES(PromotionCode, Description, ZPVGroupDesc) DISPLAY(1,2,3)FILTER(ZPVGroupDesc=FP(DerZPVDescGroup)))', 
 NULL, NULL, NULL, 
 NULL, 0, 1, 0, 
 NULL, NULL, 0, 0, 0, 
 NULL, NULL, NULL, NULL, 
