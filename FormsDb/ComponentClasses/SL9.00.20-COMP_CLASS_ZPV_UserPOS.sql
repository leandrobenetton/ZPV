...
-------------------------------------------------------------------------------
DECLARE @FormID int
DELETE FROM PropertyDefaults WHERE [PropertyName] = N'ZPV_UserPOS' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 

DELETE FROM PropertyDefaultDragDropEvents WHERE [PropertyName] = N'ZPV_UserPOS' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 
...
VALUES ( 
 N'ZPV_UserPOS', 1, N'[NULL]', 
 NULL, NULL, N'STDOLE ZPV_UserPos(  PROPERTIES(Username, PosCode, ZpvSlsman, EndUserType, PosDefault, Master) ORDERBY(PosDefault ASC))', 
 NULL, NULL, NULL, 
 N'ZPV_UserPOS(%1,%2,%3,%4,%5,%6)', 0, 1, 0, 
 NULL, NULL, 0, 0, 0, 
 NULL, NULL, NULL, NULL, 
 NULL, NULL, 0, NULL, 
