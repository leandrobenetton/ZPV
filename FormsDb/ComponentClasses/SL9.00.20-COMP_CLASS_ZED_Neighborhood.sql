...
-------------------------------------------------------------------------------
DECLARE @FormID int
DELETE FROM PropertyDefaults WHERE [PropertyName] = N'ZED_Neighborhood' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 

DELETE FROM PropertyDefaultDragDropEvents WHERE [PropertyName] = N'ZED_Neighborhood' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 
...
VALUES ( 
 N'ZED_Neighborhood', 1, N'[NULL]', 
 NULL, NULL, N'STDOLE ZED_Neighborhood(  PROPERTIES(NeighNum, NeighDetail) DISPLAY(1,2)ORDERBY(NeighDetail asc))', 
 N'ZED_Neighborhood', N'NeighNum', N'ZED_Neighborhood', 
 NULL, 0, 1, 0, 
 NULL, NULL, 0, 0, 0, 
 NULL, NULL, NULL, NULL, 
