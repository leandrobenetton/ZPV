...
-------------------------------------------------------------------------------
DECLARE @FormID int
DELETE FROM PropertyDefaults WHERE [PropertyName] = N'ZRT_UserPOS' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 

DELETE FROM PropertyDefaultDragDropEvents WHERE [PropertyName] = N'ZRT_UserPOS' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 
...
VALUES ( 
 N'ZRT_UserPOS', 1, N'[NULL]', 
 NULL, NULL, N'STDOLE ZRT_UserPos(  PROPERTIES(Username, PosCode, ZrtSlsman, EndUserType) )', 
 NULL, NULL, NULL, 
 N'ZRT_UserPOS(%1,%2,%3)', 0, 1, 0, 
 NULL, NULL, 0, 0, 0, 
 NULL, NULL, NULL, NULL, 
 NULL, NULL, 0, NULL, 
