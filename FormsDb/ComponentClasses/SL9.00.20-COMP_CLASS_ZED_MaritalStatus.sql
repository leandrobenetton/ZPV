...
-------------------------------------------------------------------------------
DECLARE @FormID int
DELETE FROM PropertyDefaults WHERE [PropertyName] = N'ZED_MaritalStatus' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 

DELETE FROM PropertyDefaultDragDropEvents WHERE [PropertyName] = N'ZED_MaritalStatus' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 
...
VALUES ( 
 N'ZED_MaritalStatus', 1, N'[NULL]', 
 NULL, NULL, N'INLINE ENTRIES(C\sZedMaritalStatus=C,E\sZedMaritalStatus=E,S\sZedMaritalStatus=S,U\sZedMaritalStatus=U,V\sZedMaritalStatus=V) DISPLAY(2) VALUE(1)', 
 NULL, NULL, NULL, 
 NULL, 0, 0, 0, 
 NULL, NULL, 0, 0, 0, 
 NULL, NULL, NULL, NULL, 
