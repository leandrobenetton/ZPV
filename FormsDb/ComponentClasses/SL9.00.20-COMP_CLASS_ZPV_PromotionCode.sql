...
-------------------------------------------------------------------------------
DECLARE @FormID int
DELETE FROM PropertyDefaults WHERE [PropertyName] = N'ZPV_PromotionCode' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 

DELETE FROM PropertyDefaultDragDropEvents WHERE [PropertyName] = N'ZPV_PromotionCode' AND [IsPropertyClassExtension] = 0 AND [ScopeType] = 1 AND [ScopeName] = N'[NULL]' 
...
VALUES ( 
 N'ZPV_PromotionCode', 1, N'[NULL]', 
 NULL, NULL, N'STDOLE ZPV_SLPricePromotions(  PROPERTIES(PromotionCode, Description, PromotionDiscount) DISPLAY(1,2,3))', 
 NULL, NULL, NULL, 
