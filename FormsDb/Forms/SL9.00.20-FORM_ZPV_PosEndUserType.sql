...
DECLARE @FormID int
SET @FormID = NULL
SELECT @FormID = Forms.ID FROM Forms WHERE [Name] = N'ZPV_PosEndUserType' AND [ScopeType] = 1
...
VALUES ( 
  1, N'[NULL]', NULL, N'ZPV_PosEndUserType', NULL, 1, N'fZPV_PosEndUserType', 
  N'ZPV_PosEndUsers( OBJNAME(oZpvPosEndUsers) )', 
...
VALUES (
  ...
  2, 15, CAST('1' AS float), CAST('12' AS float), CAST('12.5' AS float), CAST('0' AS float), CAST('15' AS float), N'sEndUserType', 
  NULL, 
  N'FormCollectionGrid', 1, N'object.EndUserType', 
...
VALUES (
  ...
  0, 14, CAST('0.53333333333333333' AS float), CAST('1.8571428571428572' AS float), CAST('12.466666666666667' AS float), CAST('0' AS float), CAST('76.285714285714292' AS float), NULL, 
  NULL, 
  NULL, 0, N'objects', 
