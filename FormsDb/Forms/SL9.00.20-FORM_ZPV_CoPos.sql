...
DECLARE @FormID int
SET @FormID = NULL
SELECT @FormID = Forms.ID FROM Forms WHERE [Name] = N'ZPV_CoPos' AND [ScopeType] = 1
...
VALUES ( 
  1, N'[NULL]', NULL, N'ZPV_CoPos', NULL, 1, N'fZRT_CoPos', 
  N'ZPV_CoPos( OBJNAME(oZPV_CoPos) )', 
...
VALUES (
  ...
  2, 15, CAST('1' AS float), CAST('12' AS float), CAST('12.5' AS float), CAST('0' AS float), CAST('30' AS float), N'sDescription', 
  NULL, 
...
VALUES (
  ...
  0, 14, CAST('1' AS float), CAST('2' AS float), CAST('12.466666666666667' AS float), CAST('0' AS float), CAST('77.285714285714292' AS float), NULL, 
  NULL, 
  NULL, 0, N'objects', 
...
VALUES (
  ...
  1, 15, CAST('1' AS float), CAST('6' AS float), CAST('12.5' AS float), CAST('0' AS float), CAST('12' AS float), N'sZRT_PosCode', 
  NULL, 
  N'FormCollectionGrid', 0, N'object.PosCode', 
  1, NULL, NULL, NULL, NULL, NULL, 
  NULL, 
  0, NULL, 0, 0, NULL, NULL, NULL, 0, N'StdDefault', 
  NULL, NULL, NULL, 
...
INSERT INTO FormComponents (
  ...
  [Description], [EffectiveCaption] )
VALUES (
  @FormID, N'PrefixGridCol', -1, 
  0, 15, CAST('0' AS float), CAST('0' AS float), CAST('6.666666666666667' AS float), CAST('0' AS float), CAST('8' AS float), N'Prefijo', 
  NULL, 
  N'FormCollectionGrid', 2, N'object.Prefix', 
  1, NULL, NULL, NULL, NULL, NULL, 
  NULL, 
