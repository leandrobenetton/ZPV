...
DECLARE @FormID int
SET @FormID = NULL
SELECT @FormID = Forms.ID FROM Forms WHERE [Name] = N'ZPV_DrawerPtype' AND [ScopeType] = 1
...
VALUES ( 
  1, N'[NULL]', NULL, N'ZPV_DrawerPtype', NULL, 1, N'fZRT_DrawerPtype', 
  N'ZRT_DrawerPtypes(OBJNAME(oZRT_DrawerPtypes))', 
...
VALUES (
  ...
  1, 15, CAST('1' AS float), CAST('6' AS float), CAST('12.5' AS float), CAST('0' AS float), CAST('15' AS float), N'sZRT_Drawer', 
  NULL, 
  ...
  NULL, NULL, NULL, 
  N'0', N'ZRT_Drawer()', NULL, NULL, NULL, 
