...
DECLARE @FormID int
SET @FormID = NULL
SELECT @FormID = Forms.ID FROM Forms WHERE [Name] = N'ZPV_DrawerPOS' AND [ScopeType] = 1
...
VALUES ( 
  1, N'[NULL]', NULL, N'ZPV_DrawerPOS', NULL, 1, N'fZPV_DrawerPOS', 
  N'ZPV_DrawerPos(OBJNAME(oZPV_DrawerPos))', 
  1019, CAST('0' AS float), CAST('0' AS float), CAST('14.4' AS float), CAST('40' AS float), NULL, NULL, -1, 8, N'sa', 
...
VALUES (
  ...
  0, 14, CAST('1' AS float), CAST('2' AS float), CAST('12.466666666666667' AS float), CAST('0' AS float), CAST('35.285714285714285' AS float), NULL, 
  NULL, 
  NULL, 0, N'objects', 
...
VALUES (
  ...
  2, 15, CAST('1' AS float), CAST('15' AS float), CAST('12.5' AS float), CAST('0' AS float), CAST('15' AS float), N'sZPV_PosCode', 
  NULL, 
  N'FormCollectionGrid', 1, N'object.Pos', 
  1, NULL, NULL, NULL, NULL, NULL, 
  NULL, 
  0, NULL, 0, 0, NULL, NULL, NULL, 0, N'StdDefault', 
  NULL, NULL, NULL, 
  N'0', N'ZPV_POS(Pos)', NULL, NULL, NULL, 
  NULL, N'AUTOIME(NoControl)', 
  NULL, N'sZPV_PosCode')
