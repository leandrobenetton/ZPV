...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ZPV_ClearingExpensesPostSp]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[ZPV_ClearingExpensesPostSp]
GO
...
CREATE PROCEDURE [dbo].[ZPV_ClearingExpensesPostSp] (
	@pClearing		ZpvClearingType = null
,	@Infobar	    InfobarType     OUTPUT
) AS

   -- Check for existence of Generic External Touch Point routine (this section was generated by SpETPCodeSp and inserted by CallETPs.exe):
   IF OBJECT_ID(N'dbo.EXTGEN_ZPV_ClearingExpensesPostSp') IS NOT NULL
   BEGIN
      DECLARE @EXTGEN_SpName sysname
      SET @EXTGEN_SpName = N'dbo.EXTGEN_ZPV_ClearingExpensesPostSp'
