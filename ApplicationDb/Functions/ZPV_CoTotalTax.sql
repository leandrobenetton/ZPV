/****** Object:  UserDefinedFunction [dbo].[ZPV_CoTotalTax]    Script Date: 07/19/2014 15:43:06 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ZPV_CoTotalTax]') AND type in (N'FN', N'IF', N'TF', N'FS', N'FT'))
DROP FUNCTION [dbo].[ZPV_CoTotalTax]
GO
...
/* $Header: /ApplicationDB/Stored Procedures/ZPV_CoTotalTax 1      */
/*
***************************************************************
*                                                             *
*                           NOTICE                            *
...
/* $Archive: /ApplicationDB/Stored Procedures/ZPV_CoTotalTax $
 *
...
CREATE FUNCTION [dbo].[ZPV_CoTotalTax] (
@CoNum CoNumType
)  
